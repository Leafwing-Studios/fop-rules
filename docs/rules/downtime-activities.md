...
Whenever a creature dies while at a font of power, they start to become one with its magical energy, eventually becoming absorbed. Each time the party benefits from a rest (including from Resolve), they gain one stack of transcendence, which represents the gradual absorption of their soul by the font. Whenever you gain a stack of **transcendence** that increases your exhaustion to a level greater than or equal to 7 + your Prowess, you must make a Focus (Endurance) skill check with a difficulty of 10 + your current transcendence. If you fail, you disappear as your spirit slips away forever.
