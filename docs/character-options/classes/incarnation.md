...
* Damage that you deal while transformed cannot be prevented by any means. This includes damage type resistance or immunity, absorption, and the Block reaction, although you can still miss.
...
### Outburst: Carve
At level 11, you learn to strike at everyone around you in a reckless whirlwind.

While transformed, you can use the Outburst major action at the cost of one stack of emotion. When you do so, make a basic attack against all creatures within range of your currently equipped set of arms.
