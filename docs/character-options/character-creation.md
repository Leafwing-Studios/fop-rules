...
* Their **proficiencies,** which capture their background knowledge and training.
	* Five **skill** proficiencies. 
	...
	* Proficiency in two **special defenses.**
		* You will be harder to affect with attacks that target these attributes. See the Attributes chapter for examples.
...
* The **gear** that they begin the game with.
	* Create two sets of **arms,** with a gear score total equal to your half your Prowess.
	* Create a set of **armor,** with a gear score total equal to your half your Prowess.

Next, work with your party and the worldspeaker to determine how your character fits into the world, recording:
* Their **ideals,** which describe their personal moral code.
...
* Determine your defenses: 
	* **Basic defense:**  12 + Prowess + Agility, or 12 + Agility + any relevant armor affixes
	* **Proficient special defenses:** 10 + proficiency bonus + the corresponding attribute
	* **Other special defenses:** 10 + (proficiency bonus / 2) +  the corresponding attribute
...
## Proficiencies
No one is good at everything. Decide what areas your character has focused their attention on by selecting:
* Five **skill proficiencies,** chosen freely from the list of skills.
* Proficiency in two **special defenses,** which allow you to protect yourself more effectively against certain types of special attacks.
...
Their effects are described in more detail in the *Attributes* chapter.

Attributes can never be higher than +5 or lower than -5. There are two methods to determine their value: point buy and randomized. In point buy, the sum of your attributes must equal 5 (e.g. [+3, +2, +1, 0, -1] or [+1, +1, +1, +1, +1]). Consult the *Attributes* chapter for the details on randomized statistics.
